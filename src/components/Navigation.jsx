          ...
          <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div className="navbar-collapse text-center">
              <ul className="nav ms-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><NavLink className="nav-link" to="/Lottories">One Dallar Lottery</NavLink></li>
                <li><NavLink className="nav-link" to="/Mytickets">Two Dallar Lottery</NavLink></li>
                <li><NavLink className="nav-link" to="/Specialdraws">Fifty Fifty Lottery</NavLink></li>
